...
export default class CarouselModal extends React.Component {
    ...
    renderPrev() {
        ...
        return prevIndex >= 0 ? (
            <a
                className="carousel-modal__control carousel-modal__control--prev"
    ...
    renderNext() {
        ...
        return nextIndex <= this.props.items.length - 1 ? (
            <a
                className="carousel-modal__control carousel-modal__control--next"
    ...
    renderCarousel() {
        return this.props.items.map((item, i) => {
            return i === this.state.index ? (
                <div
                    className="carousel-modal__item"
